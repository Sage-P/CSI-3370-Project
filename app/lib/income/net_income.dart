...
class NetIncome{
  ...
  double  getNetIncomeMothlyAmount(){
       double sum = 0;
 ...
 Income addIncome( double amount, Frequency frequency, String description){
 ...
 void sortIncomebyAmount(){
   netincome.sort((Income a, Income b) => b.getAmount().compareTo(a.getAmount()));

 }

 void sortIncomebyMonthlyAmount(){
     netincome.sort((Income a, Income b)=> b.getMonthlyAmount().compareTo(a.getMonthlyAmount())); 
 }
 ...
 String toString(){
   String s = ' ';
      ...
      s += '\n Net Income per Month: \$' + (getNetIncomeMothlyAmount() / 100).toStringAsFixed(2); 
      return s;
 }
}